...
//     it('Status 500 if handle error when fetching fruits', async () => {
...
//     it('debería devolver un estado de respuesta 200 para una solicitud POST a /addfavfruit', (done) => {
//       const user = 'usuarioEjemplo';
